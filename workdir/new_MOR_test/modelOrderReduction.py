...
# param to reduce disk_actuator
'''
originalScene = '/home/sofauser/workdir/new_MOR_test/disk_actuator.py' 
outputDir = '/home/sofauser/workdir/new_MOR_test/mor_output/'
nodeToReduce = '/disk'
disk = ObjToAnimate( "disk/cavity",incr=0.001,incrPeriod=2,rangeOfAction=0.025)
listObjToAnimate = [disk]
...
originalScene = '/home/sofauser/workdir/new_MOR_test/quadruped.py' 
outputDir = '/home/sofauser/workdir/new_MOR_test/mor_output/'
nodeToReduce ='/model'
