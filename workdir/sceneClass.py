...
class SceneDefinition:
    ...
    def __init__(self, rootNode, design=np.zeros([1,1,1]), meshFolder="",
                 ...
                 dt=0.001, with_gui = True, debug=False):
    ...
    def fix_z(self):
        ...
        '''
        fix_string = "11 22 43 84 165 309 442 488 521 559 561 599 601 624"
    ...
    def place_materials_and_cavities_and_solvers(self):
        ...
        print("THINGS ARE LOADED", self.meshFolder)
        ...
        self.rootNode.createObject( 'EulerImplicitSolver', name='integration')
        self.rootNode.createObject( 'SparseLDLSolver', name="solver")
        ...
        for ijk in np.ndindex(self.design.shape):
            ...
            if self.design[ijk] == 0:
                ...
                cavity = self.volume.createChild(node_name)
                ...
                cavity.createObject('MechanicalObject', name=node_name)
                # this pressure constraint is how the cavity is actually controlled
                cavity.createObject('SurfacePressureConstraint',   name="SurfacePressureConstraint",    template='Vec3d', value="7.0001",   triangles='@topo.triangles', drawPressure='0',  drawScale='0.0002', valueType="pressure")
    ...
    def action(self, act):
        ...
        for ijk in np.ndindex(self.design.shape):
            ...
            if self.design[ijk] == 0:
                ...
                node_name = 'cavity_' + str(i) + '_' + str(j) + '_' + str(k) 
                self.rootNode.volume.cavity_0_0_0.SurfacePressureConstraint.value = act[ijk]
    ...
    def observation(self):
        ...
        return self.rootNode.volume.dofs.position
...
def createScene(rootNode):
    ...
    scn.cnt = 0
    animate(my_animation, {"target": rootNode, "scn":scn}, duration=1, mode="once", onDone=ExitFunc)
